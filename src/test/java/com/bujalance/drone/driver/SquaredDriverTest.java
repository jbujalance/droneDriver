...
public class SquaredDriverTest {
	...
	public void getCellIdsToVisitOnZeroRange() {
		...
		IDriver squaredDriver = new SquaredDriver(new Grid(5, 5));

		// WHEN retrieving the ids to visit for the central cell on range 0
		Set<String> cellIdsToVisit = squaredDriver.getCellIdsToVisit(new Coords(2, 2), 0);
	...
	public void getCellIdsToVisitOnFirstRange() {
		...
		Set<String> cellIdsToVisit = squaredDriver.getCellIdsToVisit(new Coords(2, 2), 1);
	...
	public void getCellIdsToVisitOnSecondRange() {
		...
		Set<String> cellIdsToVisit = squaredDriver.getCellIdsToVisit(new Coords(2, 2), 2);
	...
	public void getCellIdsToVisitOnLimitBounds() {
		...
		Set<String> cellIdsToVisit = squaredDriver.getCellIdsToVisit(new Coords(4, 4), 1);

		// THEN the drivere is still able to return the ids to visit
		assertEquals(4, cellIdsToVisit.size());
		assertThat(cellIdsToVisit, hasItems(
				"Cell_3,3", "Cell_3,4",
				"Cell_4,3", "Cell_4,4"));
	}
	...
	public void getCellIdsToVisitForOriginCellOutOfBounds() {
		...
		squaredDriver.getCellIdsToVisit(new Coords(3, 3), 1);
